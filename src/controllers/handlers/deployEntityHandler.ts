...
export async function deployEntity(
  ctx: FormDataContext & HandlerContextWithPath<"ethereumProvider" | "storage" | "fetch", "/content/entities">
  ...
  return {
    ...
    body: {
      ...
      message: [`Your entity was deployed to a custom content server!`, `The URN for your entity is:\n  ${urn}`].join(
        "\n"
      ),
    },
  }
